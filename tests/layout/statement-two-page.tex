...
% stranded lines. The successor question is a vertical-rhythm change, open as
% #351, and this figure is what it has to move.
%
% Delete this line when it does. The runner fails a declaration that is no
% longer needed, so nothing has to remember to.
% PAGEFILLFLOOR: 85
