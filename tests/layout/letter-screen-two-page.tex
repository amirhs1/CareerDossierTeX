% letter-screen-two-page.tex — medium=screen (issue #184): a multi-page cover
% letter must carry no folio on any page and no running header on page two. The
% page break is forced; see resume-screen-two-page.tex for why.
\documentclass[medium=screen]{careerdossier-letter}
\CDossierSetup{
  name     = {Ada Lovelace},
