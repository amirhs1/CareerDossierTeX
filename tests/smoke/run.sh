...
cases=(
  ...
  "resume-density-option fail|Supported options are 'fontsize', 'margin', 'paper', 'bodyfont', 'medium', and 'muted'."
  ...
  "cv-density-option fail|Supported options are 'fontsize', 'margin', 'paper', 'bodyfont', 'medium', and 'muted'."
