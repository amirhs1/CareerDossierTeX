...
cases=(
  ...
  "resume-accent-theme pass"
  "resume-accent-theme-tagged pass"
  ...
  "resume-bad-theme fail|accepts only a fixed set of"
  "resume-accent-without-theme fail|'accent' option requires"
  ...
  "cv-valid pass"
  "cv-sans-body pass"
  "cv-bad-print-theme fail|accepts only a fixed set of"
  "cv-accent-without-theme fail|'accent' option requires"
  ...
  "cv-bad-accent fail|accepts only a fixed set of"
  ...
  "letter-bad-accent fail|accepts only a fixed set of"
  "letter-accent-without-theme fail|'accent' option requires"
  ...
  "statement-bad-theme fail|accepts only a fixed set of"
  "statement-accent-without-theme fail|'accent' option requires"
