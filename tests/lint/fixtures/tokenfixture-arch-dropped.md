<!-- tokenfixture-arch-dropped.md — a token the source declares has no row. Without this direction the lint could be satisfied by deleting rows. -->

A declared token the table has stopped documenting.
