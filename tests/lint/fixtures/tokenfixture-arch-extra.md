<!-- tokenfixture-arch-extra.md — a row for a token the source does not declare, which is what a removed token leaves behind. -->

A documented token the source no longer declares.
