<!-- tokenfixture-arch-derived.md — a derived metric's factor perturbed (0.04 -> 0.05) while its point columns still read 0.4/0.44/0.48. Both halves of that row are claims and both are checked. -->

A derivation that no longer matches its declaration.
...
|---|---|---:|---:|---:|
| `\CDossierRuleThickness` | 0.05 × body size | 0.4 pt | 0.44 pt | 0.48 pt |
