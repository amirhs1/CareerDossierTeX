...
\midrule
\endhead
Section size & \cmd{CDossierSizeSection} --- 11 / 12 / 13\,pt \\
Subsection size & \cmd{CDossierSizeBody} --- 10 / 11 / 12\,pt \\
...
\cmd{tolerance}. It is 2.00 times the body size --- 20\,pt, 22\,pt, and 24\,pt at
\opt{fontsize=10pt}, \opt{11pt}, and \opt{12pt} --- and it derives from the body
size rather than the body leading because the quantity is horizontal. It does
