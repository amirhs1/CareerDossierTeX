...
| **Any behavior change**            | `docs/TESTING.md` § "Coverage expectations" (the test coverage matrix); `.agents/skills/release-notes/reference.md` § "The shape of an entry" — how to write the `CHANGELOG.md` entry rule 7 requires; the rows below name that *file*, not this *rule*                                                                                                                                                                          |
| Token, spacing, or vertical rhythm | `doc/careerdossier.tex` (the token chapter), `docs/TESTING.md` § "Spacing tokens: reporting a value is not rendering a gap", `CHANGELOG.md`                                                                                                     |
| Layout, page break, or typography  | `doc/careerdossier.tex`, `docs/TESTING.md` § "Visual review targets", `CHANGELOG.md`                                                                                                                                                             |
| Tagging or PDF structure           | `docs/ATS-EXTRACTION.md`, `doc/careerdossier.tex`, `docs/TESTING.md` § "Tagged-PDF suite"                                                                                                                                                       |
| Extraction or reading order        | `docs/ATS-EXTRACTION.md`, `docs/TESTING.md` § "Extraction round-trip test"                                                                                                                                                                      |
| Bibliography or Biber              | `doc/careerdossier.tex`, `docs/ARCHITECTURE.md` (the BibLaTeX boundary), `docs/TESTING.md` § "BibLaTeX/Biber fixture"                                                                                                                           |
